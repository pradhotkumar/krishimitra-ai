        ...
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-text/70">
              {isLogin 
                ? 'Sign in to continue to KrishiMitra AI'
                : 'Join KrishiMitra AI to get started'}
            </p>
          </div>
          ...
          <div className="glass p-8 rounded-lg shadow-soft">
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-text/50">Or continue with</span>
                </div>
              </div>

              <div className="mt-6 grid grid-cols-2 gap-3">
                <button className="flex items-center justify-center px-4 py-2 border border-primary/20 rounded-lg hover:bg-primary/5 transition-colors">
            ...
            {/* Terms */}
            {!isLogin && (
              <p className="mt-6 text-xs text-center text-text/50">
